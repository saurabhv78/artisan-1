...
class _SignUpPageState extends ConsumerState<SignUpPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final contentWidth = isTablet ? 480.0 : MediaQuery.of(context).size.width;
                        ...
                        children: [
                          ...
                          CustomAuthTextField(
                            ...
                            initialText: ref.read(
                              signUpPageModelProvider.select((v) => v.name),
                            ),
                            maxLength: null,
                            backgroundColor: Colors.black.withOpacity(0.3),
                            onChanged: ref
                          ...
                          CustomAuthTextField(
                            ...
                            isEnabled: !isProcessing,
                            initialText: ref.read(
                              signUpPageModelProvider.select((v) => v.email),
                            ),
                            maxLength: null,
                            backgroundColor: Colors.black.withOpacity(0.3),
                            onChanged: ref
                          ...
                          //   isDigitOnly: true,
                          //   initialText: ref.read(
                          //     signUpPageModelProvider.select((v) => v.mobile),
                          //   ),
                          //   maxLength: 10,
                          //   backgroundColor: Colors.black.withOpacity(0.3),
                          //   onChanged: ref
                          ...
                          CustomAuthTextField(
                            ...
                            isEnabled: !isProcessing,
                            initialText: ref.read(
                              signUpPageModelProvider.select((v) => v.password),
                            ),
                            backgroundColor: Colors.black.withOpacity(0.3),
                            suffix: GestureDetector(
                              onTap: () {
                          ...
                          CustomAuthTextField(
                            ...
                            isEnabled: !isProcessing,
                            initialText: ref.read(
                              signUpPageModelProvider
                                  .select((v) => v.confirmPassword),
                            ),
                            backgroundColor: Colors.black.withOpacity(0.3),
                            suffix: GestureDetector(
                              onTap: () {
