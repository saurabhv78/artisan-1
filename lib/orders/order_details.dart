...
class _OrderDetailsPageState extends ConsumerState<OrderDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final verticalPadding = isTablet ? 24.0 : 12.0;
                  ...
                  child: ConstrainedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(Icons.check_box,
                                color: Colors.green, size: isTablet ? 32 : 28),
                        ...
                        SizedBox(height: isTablet ? 24 : 20),
                        buildSectionTitle("Order Details", isTablet),
                        buildKeyValue("Order Number", orderData!['orderNumber'],
                            isTablet),
                        buildKeyValue(
                            "Order Placed", orderData!['createdAt'], isTablet),
                        buildKeyValue("Quantity",
                            "${orderData!['items'].length}", isTablet),
                        buildKeyValue(
                            "Total Price",
                            "\$${orderData!['pricing']['subtotal'] ?? 0}",
                            isTablet),
                        buildKeyValue("Order Status", orderData!['orderStatus'],
                            isTablet),
                        buildKeyValue("Payment Status",
                            orderData!['paymentStatus'], isTablet),
                        buildKeyValue("Payment Method",
                            orderData!['paymentMethod'], isTablet),
                        Divider(height: isTablet ? 40 : 32),
                        buildSectionTitle("Bill Summary", isTablet),
                        buildKeyValue(
                            "Item Subtotal",
                            "\$${orderData!['pricing']['subtotal'] ?? 0}",
                            isTablet),
                        ...
                        Divider(height: isTablet ? 40 : 32),
                        buildSectionTitle("Shipping Address", isTablet),
                        SizedBox(height: 8),
                        Text(
                          "Deliver to ${orderData!['shippingAddress']['fullName']}, +91${orderData!['shippingAddress']['contactNumber']}",
                          style: GoogleFonts.nunitoSans(
  ...
  Widget buildKeyValue(String title, String value, bool isTablet) {
    return Padding(
      padding: EdgeInsets.symmetric(vertical: isTablet ? 6 : 2),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(title,
  ...
  Widget buildSectionTitle(String title, bool isTablet) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 8.0),
      child: Text(
        title,
        style: GoogleFonts.nunitoSans(
            fontSize: isTablet ? 20 : 16, fontWeight: FontWeight.w600),
      ),
    );
  }
}
